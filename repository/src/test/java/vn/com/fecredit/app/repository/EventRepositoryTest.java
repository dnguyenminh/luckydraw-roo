...
public class EventRepositoryTest extends AbstractRepositoryTest {
    ...
    void findByStartTimeBetween_ShouldReturnEventsInRange() {
        ...
        // Should only include CURRENT and INACTIVE as their startTime falls within
        // range
        assertThat(results)
                .extracting("code")
    ...
    void hasOverlappingEvents_ShouldIdentifyOverlaps() {
        ...
        assertThat(eventRepository.hasOverlappingEvents(
                ...
                currentEvent.getEndTime())).isTrue();

        // Test non-overlapping time range
        assertThat(eventRepository.hasOverlappingEvents(
                currentEvent.getId(),
                baseTime.plusHours(5),
                baseTime.plusHours(6))).isFalse();
    }
    ...
    void hasOverlappingEvents_ShouldNotConsiderInactiveEvents() {
        ...
        assertThat(eventRepository.hasOverlappingEvents(
                ...
                inactiveEvent.getEndTime())).isFalse();
    }
}
